...
SCENARIO("Testing BSTLEAF.insert() & BSTLEAF.lookup(). . .") {
	GIVEN("Keys 5, 10, 15, 20, 25, and 30 containing A, B, C, D, E, and F, respectively. . .") {
		BSTLEAF<int, char, compare, equal> * BST = new BSTLEAF<int, char, compare, equal>;
...
SCENARIO("Testing BSTLEAF.remov(). . .") {
	GIVEN("Keys 5, 3, 7, 2, 9, 1, and 11 containing 5, 10, 15, 20, 25, 30, and 35, respectively. . .") {
		BSTLEAF<int, int, compare, equal> * BST = new BSTLEAF<int, int, compare, equal>;
...
SCENARIO("Testing BSTLEAF->contains(). . .") {
	GIVEN("Keys 5, 10, 15, 20, 25, and 30 containing A, B, C, D, E, and F, respectively. . .") {
		BSTLEAF<int,char,compare, equal> *BST = new BSTLEAF<int,char,compare, equal>;
...
SCENARIO("Testing BSTLEAF->is_full() & BSTLEAF->is_empty(). . .") {
	GIVEN("Keys 5, 10, 15, 20, 25, and 30 containing A, B, C, D, E, and F, respectively. . .") {
		BSTLEAF<int,char,compare, equal> *BST = new BSTLEAF<int,char,compare, equal>;
...
SCENARIO("Testing BSTLEAF->height() & BSTLEAF->size(). . .") {
	GIVEN("Keys 5, 10, 15, 20, 25, and 30 containing A, B, C, D, E, and F, respectively. . .") {
		BSTLEAF<int,char,compare, equal> *BST = new BSTLEAF<int,char,compare, equal>;
...
SCENARIO("Testing BSTLEAF->balance(). . .") {
...
SCENARIO("Testing BSTLEAF->clear(). . .") {
	GIVEN("Keys = 5, 10, 15, 20, 25, 30 & Values = 'C', 'B', 'R', 'M', 'P', 'H' (respectively)") {
		BSTLEAF<int,char,compare, equal> *BST = new BSTLEAF<int,char,compare, equal>;
...
SCENARIO("Testing the big five. . .") {
	GIVEN("Keys 5, 10, 15, 20, 25, and 30 containing A, B, C, D, E, and F, respectively. . .") {
		...
		WHEN("Checking the copy constructor. . .") {
			BSTLEAF<int, char, compare, equal> CCBST = BST;
		...
		WHEN("Checking the copy assignment. . .") {
			BSTLEAF<int, char, compare, equal> CABST = BST;
		...
		WHEN("Checking the move assignment. . .") {
			BSTLEAF<int, char, compare, equal> MABST;
		...
		WHEN ("Checking the move constructor. . .") {
			BSTLEAF<int, char, compare, equal> MCBST(std::move(BST));
			THEN("Looking up values. . .") {
